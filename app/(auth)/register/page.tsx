...
//                 type="submit"
//                 className="py-6 bg-[#50C2C9] w-full text-lg font-semibold transition-all cursor-pointer hover:bg-[#50c3c9ba]"
//               >
//                 Register
//               </Button>
//             </div>
...
//         <div className="mb-20 mx-auto w-fit">
//           <p className="text-base">Already have an account ? <span className="text-[#50C2C9]"><Link href={"/#"}>Sign In</Link></span> </p>
//         </div>
//       </div>
//     </section>
//   );
